...
public class AttendanceAppGUI extends JFrame {
    ...
    private JLabel createStatCard(String title, String value, java.awt.Color color, String emoji) {
        JLabel card = new JLabel("<html><div style='background: white; border: 1px solid #e0e0e0; border-radius: 8px; padding: 20px; text-align: center;'>"
            + "<div style='font-size: 24px; margin-bottom: 8px;'>" + emoji + "</div>"
            + "<div style='font-size: 14px; color: #666; margin-bottom: 8px;'>" + title + "</div>"
            + "<div style='font-size: 32px; font-weight: bold; color: " + String.format("#%02x%02x%02x", color.getRed(), color.getGreen(), color.getBlue()) + ";'>" + value + "</div>"
            + "</div></html>");
    ...
    private void updateDashboardStats() {
        ...
        if (mergeResult != null) {
            ...
            totalEmployeesLabel.setText("<html><div style='background: white; border: 1px solid #e0e0e0; border-radius: 8px; padding: 20px; text-align: center;'>"
            ...
            presentTodayLabel.setText("<html><div style='background: white; border: 1px solid #e0e0e0; border-radius: 8px; padding: 20px; text-align: center;'>"
                + "<div style='font-size: 24px; margin-bottom: 8px;'>✅</div>"
            ...
            absentTodayLabel.setText("<html><div style='background: white; border: 1px solid #e0e0e0; border-radius: 8px; padding: 20px; text-align: center;'>"
                + "<div style='font-size: 24px; margin-bottom: 8px;'>❌</div>"
            ...
            lateArrivalsLabel.setText("<html><div style='background: white; border: 1px solid #e0e0e0; border-radius: 8px; padding: 20px; text-align: center;'>"
                + "<div style='font-size: 24px; margin-bottom: 8px;'>⏰</div>"
    ...
    private JPanel createDataViewerPanel() {
        ...
        statusFilter.setModel(new DefaultComboBoxModel<>(new String[]{"All", "Present", "Absent", "Late", "Half Day"}));
    ...
    private void clearDataFilters() {
        ...
        if (dataTable.getRowSorter() != null) {
            TableRowSorter<? extends TableModel> sorter = (TableRowSorter<? extends TableModel>) dataTable.getRowSorter();
    ...
    private void queryData(ActionEvent e) {
        ...
        if (!empCode.isEmpty()) {
            ...
            for (int i = 0; i < cm.getColumnCount(); i++) {
                ...
                if (i == 1) renderer.setHorizontalAlignment(SwingConstants.LEFT);
    ...
    private void exportFilteredData() {
        ...
        if (visibleRowCount == 0) {
            JOptionPane.showMessageDialog(this, "No filtered data to export!", "Export Error", JOptionPane.WARNING_MESSAGE);
            return;
        }
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, 
                    String.format("✅ %d rows of filtered data exported successfully!\n%s", 
                        visibleRowCount, fileToSave.getAbsolutePath()), 
                    "Export Success", JOptionPane.INFORMATION_MESSAGE);
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(this, 
                    "❌ Error exporting filtered data: " + ex.getMessage(), 
    ...
    private JPanel createReportViewerPanel() {
        ...
        reportDeptFilter.setModel(new DefaultComboBoxModel<>(new String[]{"All", "IT", "HR", "Finance", "Operations"}));
        ...
        try {
            ...
            if (!isValidDate(year, month, day)) {
                JOptionPane.showMessageDialog(this, 
                    ...
                    "\n" + getMonthName(month) + " has only " + YearMonth.of(year, month).lengthOfMonth() + " days.", 
            ...
            if (!holidayListModel.contains(holidayString)) {
                ...
                JOptionPane.showMessageDialog(this, "This date is already in the holiday list.", 
                    "Duplicate Holiday", JOptionPane.WARNING_MESSAGE);
            }
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Error adding holiday: " + ex.getMessage(), 
    ...
    private void removeHoliday() {
        ...
        if (selectedIndex != -1) {
            ...
            JOptionPane.showMessageDialog(this, "Please select a holiday to remove.", 
    ...
    private void exportMergedFile(ActionEvent e) {
        ...
        if (res == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                JOptionPane.showMessageDialog(this, "Error exporting merged file: " + ex.getMessage(), 
                    "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
